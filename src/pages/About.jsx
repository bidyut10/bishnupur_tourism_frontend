      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="md:flex md:items-center md:justify-between">
          <div className="flex-1 min-w-0">
            <h1 className="text-4xl md:text-5xl font-bold leading-7 text-gray-900 sm:text-3xl sm:leading-9 sm:truncate">
              Why Choose Bishnupur?
            </h1>
            <p className="mt-3 md:mt-5 text-base md:text-lg leading-7 font-medium text-gray-500">
            ...
            <div className="mt-5 md:mt-10 sm:flex sm:justify-center lg:justify-start">
              <div className="mt-3 sm:mt-0 sm:ml-3">
                <a
                  href="#"
                  className="flex items-center justify-center border border-transparent text-base md:text-lg leading-6 font-medium rounded-md text-green-600 bg-white hover:text-green-500 focus:outline-none focus:shadow-outline-blue transition duration-150 ease-in-out"
                >
                  Learn More
                </a>
              </div>
          ...
          <div className="mt-5 md:mt-0 md:ml-4 flex-shrink-0">
            <img
              className="h-full md:h-56 w-full p-10 md:w-72"
              src={image}
              alt="About Us"
            />
          </div>
